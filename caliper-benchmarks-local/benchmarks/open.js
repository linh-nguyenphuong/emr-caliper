...
module.exports.info = 'Query all EMR';
...
function generateWorkload() {
    ...
    let patient = {
        ...
        first_name: "Ed",
        last_name: "Helen TESTTTTTTTTTTTTTTTTT",
        gender: "Nữ",
        role: "patient",
        avatar: null,
        DOB: "1990-01-01"
    ...
    for (let i = 0; i < txnPerBatch; i++) {
        ...
        workload.push({
            chaincodeFunction: 'createEMR',
            chaincodeArguments: [uuid(), JSON.stringify(patient), JSON.stringify(physician), JSON.stringify(room), JSON.stringify(medical_record), '9858302d-041b-4bec-98d4-a017f2449999'],
        });

        workload.push({
            chaincodeFunction: 'queryAllEMRs',
            chaincodeArguments: [],
            invokerIdentity: 'client0.org1.emr.com'
        });
...
module.exports.run = function () {
    ...
    return bc.querySmartContract(contx, 'emr-chaincode', '3', args, 20);
};
